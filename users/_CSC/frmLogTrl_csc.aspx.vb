...
Partial Public Class frmLogTrl_csc
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.frmLogTrl_csc.Attributes.Add("autocomplete", "off")
        Try
            If Not Page.IsPostBack Then
                ...
                Dim cmd As New SqlCommand("select userid,role,office,cir_code from  tbl_users where rtrim(userid) = @uname and role=@cscrole ", connectPrj)
                With cmd
                    .Parameters.Add(New SqlParameter("@uname", uid))
                    .Parameters.Add(New SqlParameter("@cscrole", "CSC_USER"))
                End With
    ...
    End Sub
    'function to check the authentication of the user session
