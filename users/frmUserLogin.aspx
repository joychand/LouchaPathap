<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="~/users/frmUserLogin.aspx.vb" Inherits="ponweb.frmUserLogin" EnableViewStateMac="true"%>
...
<title>Loucha Pathap manipur.. LogIn Authentication</title>  
...
<body onload="javascript:window.history.forward(-1)">
    <form id="frmUserLogin" runat="server" autocomplete="off">
    <div class="style46">
    ...
    <div class="style52">
        ...
        <asp:Panel ID="Panel1" runat="server" DefaultButton="btnLogIn" Height="283px">
            <table class="style34" align="center">
                <tr>
                    <td class="style54" colspan="2">
                        <span class="style55" lang="en-us">Welcome </span>
                    </td>
                ...
                <tr>
                    ...
                    TabIndex="1" BackColor="#CCCCFF"  autocomplete = "off" 
                ...
                <tr>
                    ...
                    <td class="style23">
                        <input id="txtpwd" tabindex="2" class="style33" runat="server" type="password" 
                    autocomplete="off"/>
                    </td>
                </tr>
                <tr>
            ...
            NoiseColor="AliceBlue" Width="162px" BackColor="#FFCC99" BorderStyle="None" />
                ...
                <tr>
                    ...
                    InitialValue="Captcha Image Here" 
                    style="text-align: center; color: #FFFFFF"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="style35" colspan="3">
                        <asp:Label ID="lberror" runat="server" CssClass="style7" ForeColor="White"></asp:Label>
                        <span class="style56" lang="en-us">04/06/2015</span></td>
                </tr>
                <tr>
