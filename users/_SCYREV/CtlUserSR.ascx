<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="CtlUserSR.ascx.vb" Inherits="ponweb.CtlUserSR"  %>
<style type="text/css">
...
<div class="style9">
   ...
   <asp:SiteMapDataSource ID="SiteMapDataSource1" SiteMapProvider="smUserSR" 
                runat="server" />
