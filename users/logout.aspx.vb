...
Partial Public Class logout
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Call LogAdTrails("Log Out", "Success", "")
        Session.Clear()
        Session.Abandon()
        Dim session_cookie As HttpCookie = New HttpCookie("ASP.NET_SessionId")
        session_cookie.Expires = DateTime.Now.AddDays(-1)
        Response.Cookies.Add(session_cookie)
        'del_user_session(userid, sessionID)
        'MsgBox("logout: " + Session("session_status").ToString)
        ...
        ' ''call log recording and then log out
